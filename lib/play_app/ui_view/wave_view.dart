          ...
          children: <Widget>[
            new ClipPath(
              child: new Container(
                decoration: BoxDecoration(
                  color: CoinsAppTheme.primary.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      CoinsAppTheme.green.withOpacity(0.2),
                      CoinsAppTheme.green.withOpacity(0.5)
                    ],
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: CoinsAppTheme.white.withOpacity(
            ...
            Column(
              children: <Widget>[
                AspectRatio(
                  aspectRatio: 1,
                  child: Image.asset("assets/imgs/bottle.png"),
                ),
              ],
            )
          ],
