  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: <Widget>[
        ...
        //                 boxShadow: <BoxShadow>[
        //                   BoxShadow(
        //                       color: CoinsAppTheme.primary.withOpacity(0.4),
        ...
        //                       context,
        //                       MaterialPageRoute(
        //                         builder: (context) => CoinsExploreScreen(
        //                             animationController: animationController),
        //                       ),
        //                     );
        //                   },
              ...
              children: <Widget>[
                ScaleTransition(
                  ...
                  child: SvgPicture.asset(
                    ...
                    width: widget.tabIconData.isSelected
                        ? widget.tabIconData.selectedSize
                        : widget.tabIconData.size,
                  ),
                ),
                Positioned(
                  top: 4,
