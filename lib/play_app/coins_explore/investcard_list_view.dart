...
class InvestCardList extends StatefulWidget {
  const InvestCardList(
  ...
  @override
  _InvestCardListState createState() => _InvestCardListState();
}

class _InvestCardListState extends State<InvestCardList>
