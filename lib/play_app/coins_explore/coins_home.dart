import 'package:crazy_play/play_app/coins_explore/home_banner_view.dart';
...
class CoinsHome extends StatefulWidget {
  const CoinsHome({Key key, this.animationController}) : super(key: key);

  final AnimationController animationController;
  @override
  _CoinsHomeState createState() => _CoinsHomeState();
}

class _CoinsHomeState extends State<CoinsHome> with TickerProviderStateMixin {
