...
class CoinsExploreScreen extends StatefulWidget {
  const CoinsExploreScreen({Key key, this.animationController})
      : super(key: key);

  final AnimationController animationController;
  @override
  _CoinsExploreScreenState createState() => _CoinsExploreScreenState();
}

class _CoinsExploreScreenState extends State<CoinsExploreScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        titleTxt: 'Idealogical Investments',
        subTxt: 'More',
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController,
            curve:
    ...
    listViews.add(
      TitleView(
        titleTxt: 'Futuristic Investments',
        subTxt: 'More',
        animation: Tween<double>(begin: 0.0, end: 1.0).animate(CurvedAnimation(
            parent: widget.animationController,
            curve:
